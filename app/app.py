...
# --- Ensure the current directory is on sys.path so local modules import cleanly ---
# (This avoids 'ModuleNotFoundError: scraper' when Gunicorn loads app:app)
...
# Kick off initial sync and schedule
initial_sync_async()
schedule_job()
